---
name: skill-creator
description: Create or update Codex skills optimized for Skillmark benchmarks. Use for new skills, skill scripts, references, benchmark optimization, extending Codex's capabilities.
version: 3.0.0
...
Create effective, benchmark-optimized Codex skills using progressive disclosure.

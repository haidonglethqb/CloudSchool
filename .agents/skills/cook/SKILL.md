...
**Codex Tasks:** Utilize all these tools `TaskCreate`, `TaskUpdate`, `TaskGet` and `TaskList` during implementation step.
...
- **Finalize (MANDATORY - never skip):**
  ...
  3. `TaskUpdate` → mark all Codex Tasks complete after sync-back verification
